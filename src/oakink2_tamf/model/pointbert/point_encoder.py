...
class PointTransformer(nn.Module):
    ...
    def load_checkpoint(self, bert_ckpt_path):
        ...
        if incompatible.missing_keys:
            _logger.info('missing_keys: \n%s', get_missing_parameters_message(incompatible.missing_keys))
        if incompatible.unexpected_keys:
            _logger.info('unexpected_keys: \n%s', get_unexpected_parameters_message(incompatible.unexpected_keys))
        if not incompatible.missing_keys and not incompatible.unexpected_keys:
            # * print successful loading
            _logger.info("PointBERT's weights are successfully loaded from %s", bert_ckpt_path)
