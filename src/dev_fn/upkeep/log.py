...
class MPMainQueueHandler(logging.handlers.QueueHandler):
...
def configure_mp_main(queue: mp.Queue):
    ...
    # set main to queue
    queue_handler = MPMainQueueHandler(queue)
...
class ConsoleFormatter(Formatter):
    FORMATS = {
        ...
        logging.INFO:
            colored(" ".join([Formatter.time_str, Formatter.level_str, Formatter.src_str, ""]), "white", attrs=["dark"])
        ...
        logging.CRITICAL:
            colored(" ".join([Formatter.time_str, Formatter.level_str, Formatter.src_str, ""]),
                    "red",
                    attrs=["dark", "bold"]) + colored(Formatter.msg_str, "red", attrs=["bold"]),
    }
